set markup html on
REM   Show session history  which is either blocked or wait class is not null
SET TERMOUT OFF;
...
PROMPT
PROMPT +--------------------------------------------------------------------------------------+
PROMPT   Report   : Session History Details(Blocked/Wait-sec)
...
--  and  s.sample_time >= to_timestamp('&&start_time', 'MM/DD/YYYY HH24:MI')
--  and s.sample_time <= to_timestamp('&&end_time', 'MM/DD/YYYY HH24:MI')
