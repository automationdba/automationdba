...
PROMPT
PROMPT +------------------------------------------------------------------------+
PROMPT | Report   : Execution plan diff  sqlid  &1                              |
...
col elapsed_per_exec_diff_pct for 999.99 heading 'Diff Plan|pct(%)'
col plan_hash_value for 9999999999 heading 'Plan|Hash Value'
col snap_count for 999 heading 'Snap|Cnt'
col total_execs for 9999999999 heading 'Total|Exec'
